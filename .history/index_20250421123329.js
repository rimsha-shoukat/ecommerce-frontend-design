...
let listItems1 = productsList.map((imgSrc) => {
    return `<div class="flex flex-row p-4 items-center justify-center bg-white rounded-md border border-gray-300 shadow gap-[1.5rem]">
       ...
       <div class="flex flex-col gap-2 items-center justify-center">
         ...
         <span>
         <p class="text-gr">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit </p>
       </div>
    </div>`;
}).join(''); 
