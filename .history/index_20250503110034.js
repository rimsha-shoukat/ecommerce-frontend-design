...
let listItems1 = productsList1.map((imgSrc) => {
    ...
    <a href="productDetails.html"> <img class="w-[15rem] p-2" src="${imgSrc}"/> </a>
       ...
       <span class="save px-2 py-[0.3rem] border border-gray-300 shadow rounded-md cursor-pointer text-[#1491f0]" save=${imgSrc}>
...
let listItems2 = productsList2.map((imgSrc) => {
    return `<div id="saveIcon" class="flex flex-col p-4 items-center justify-center bg-white rounded-md border border-gray-300 shadow gap-[2rem]">
        ...
        <div class="flex flex-row gap-4">
            ...
            <span class="heart w-[3rem] h-[2.5rem] p-2 border border-gray-300 shadow rounded-md cursor-pointer text-[#1491f0]" save=${imgSrc} >
              <i class="fa-regular fa-heart fa-lg"></i>
            </span>
        </div>
    </div>`;
...
let saveBtn = document.getElementById("saveIcon");
