...
//layout html
Layout.innerHTML = `
    <div onclick="toggleDisplay(false)" class="cursor-pointer py-2 px-[0.65rem] ${displayRow? "bg-white" : "bg-gray-300"}">
        <i class="fa-lg fa-brands fa-microsoft"></i>
    </div>
    <div onclick="toggleDisplay(true)" class="cursor-pointer ${displayRow? "bg-gray-300" : "bg-white"} py-2 px-[0.65rem] border-l border-gray-300">
...
let productsList2 = ["assests/electronics-category-img4.png","assests/product1.png", "assests/deal-img5.png", "assests/electronics-category-img5.png", "assests/deal-img3.png", "assests/product1.png", "assests/deal-img2.png", "assests/deal-img1.png", "assests/electronics-category-img4.png"]
