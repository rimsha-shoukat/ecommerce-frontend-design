    ...
    if(saveItems.length > 0){
        let saveList = saveItems.map((Item) => {
            return `<span class="flex flex-col items-start justify-start">
                      ...
                      <h1 class="text-gray-400 leading-5 max-[970px]:text-xs">GoPro HERO6 4K Action <br class="max-[350px]:hidden"> Camera - Black</h1>
    ...
    if(item.length > 0){
        let cartHtml = item.map((i) =>{
            return `<span class="flex flex-row max-[680px]:flex-col items-start justify-between border-b p-4 max-[1020px]:p-0 border-gray-300 w-[100%]">
                        <span class="flex flex-row items-center justify-center gap-4 max-[350px]:gap-2">
                        ...
                        <span class="flex flex-col items-start justify-start">
                            ...
                            <h1 class="max-[580px]:hidden text-gray-500 text-nowrap max-[480px]:text-sm">Size: medium, Color: blue,  Material: Plastic <br>Seller: Artel Market</h1>
                            <span class="flex flex-row gap-6 max-[350px]:gap-2 mt-4">
                        ...
                        <span class="flex flex-col max-[680px]:flex-row-reverse max-[680px]:mt-4 max-[680px]:w-[100%] max-[680px]:justify-between gap-2 items-start justify-end">
                            <h1 class="font-semibold">$78.99</h1>
                            <div class="flex flex-row items-center justify-between px-2 py-[0.3rem] font-semibold gap-4 max-[680px]:gap-6 w-auto border border-gray-300 shadow rounded-md">
                                <h1>Qty:</h1>
                                <select>
