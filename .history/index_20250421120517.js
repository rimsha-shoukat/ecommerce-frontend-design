...
let list1 = productsList.map(p=>{
    `<div class="flex flex-row items-center justify-center gap-[1rem] p-2">
       <img src="${p.}"/>
    </div>`
});
let list2 = ``;
...
products.innerHtml = `<div class="grid ${displayRow? "grid-cols-1" : "grid-cols-4"} gap-[1rem] w-[100%] h-auto">${displayRow? list1 : list2}</div>`
