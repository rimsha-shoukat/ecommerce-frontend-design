...
let saveItems = ["assests/electronics-category-img3.png", "assests/product1.png", "assests/deal-img1.png", "assests/deal-img2.png"];
...
saved.addEventListener("click", (event) => {
  if(event.target.closest('saveBtn')) {
    console.log("clicked");
    let saevent.target.closest('saveBtn')
    let newSave = saveBtn.getAttribute('save')
    .innerHTML = `<i class="fa-solid fa-heart fa-lg" style="color: #db0000;"></i>`
