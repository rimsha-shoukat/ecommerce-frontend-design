...
function moved(item){
    if(item.length > 0){
        let cartHtml = item.map((i) =>{
            return `<span class="flex flex-row items-start justify-between border-b p-4 max-[1020px]:p-0 border-gray-300 w-[100%]">
                        <span class="flex flex-row items-center justify-center gap-4 max-[680px]:flex-col">
                        ...
                        <span class="flex flex-col gap-2 items-start justify-end">
