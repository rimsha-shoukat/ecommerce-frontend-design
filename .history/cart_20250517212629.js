...
function moved(item){
    if(item.length > 0){
        let cartHtml = item.map((i) =>{
            return `<span class="flex flex-row items-center justify-between border-b p-4 border-gray-300 w-[100%]">
                        ...
                        <span class="flex flex-col gap-2 items-start justify-start">
