...
let cart = ["assests/item1.png", "assests/item5.png", "assests/item5.png"];

let cartItems = document.getElementById("cartItems");
if(cart){
    let cartHtml = cart.map((ite))
}
cartItems.innerHTML = `<span class="flex flex-row items-start justify-start gap-4 border-b p-4 border-gray-300 w-[100%]">
                    <img class="w-[8rem] h-[8rem] border border-gray-300 shadow p-2 rounded-md" src="assests/item1.png" alt="img">
