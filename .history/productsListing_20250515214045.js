...
let listItems1 = productsList1.map((imgSrc) => {
    return `<div id="saveIcon" class="flex flex-row max-[760px]:p-2 p-4 items-start justify-start bg-white rounded-md border border-gray-300 shadow gap-[1.5rem]">
       ...
       <div class="flex flex-col w-[100%] gap-2 items-start justify-start">
         ...
         <div class="flex flex-col">
           ...
           <span class="flex flex-row gap-2 items-center justify-center">
            ...
            <i class="fa-solid fa-circle text-[6px] max-[590px]:hidden" style="color: #b0b7c4;"></i>
            <p class="text-gray-500 max-[590px]:hidden">154 orders</p>
            <i class="max-[590px]:hidden fa-solid fa-circle text-[6px]" style="color: #b0b7c4;"></i>
            <p class="max-[590px]:hidden text-green-500">Free Shipping</p>
         </span>
         </div>
...
let listItems2 = productsList2.map((imgSrc) => {
    return `<div id="saveIcon" class="flex flex-col p-4 max-[760px]:p-2 items-center justify-center bg-white rounded-md border border-gray-300 shadow gap-[2rem]">
        <a href="productDetails.html" class="itemDetail" detail="${imgSrc}"> <img class="w-[15rem] max-[760px]:p-0 p-2 h-[13rem]" src="${imgSrc}"/> </a>
