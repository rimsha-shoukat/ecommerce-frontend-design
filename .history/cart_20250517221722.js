...
function moved(item){
    if(item.length > 0){
        let cartHtml = item.map((i) =>{
            return `<span class="flex flex-row max-[680px]:flex items-start justify-between border-b p-4 max-[1020px]:p-0 border-gray-300 w-[100%]">
                        ...
                        <span class="hidden max-[680px]:block">
                            <h1 class="font-semibold">$78.99</h1>
                        </span>
                        <span class="flex flex-col gap-2 items-start justify-end max-[680px]:hidden">
                            <h1 class="font-semibold">$78.99</h1>
