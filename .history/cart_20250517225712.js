    ...
    if(saveItems.length > 0){
        let saveList = saveItems.map((Item) => {
            return `<span class="flex flex-col items-start justify-start">
                      <img class="w-[14rem] max-[480px]:w-[6rem] max-[970px]:h-[6rem] border px-2 py-4 border-gray-300 shadow rounded-sm mb-4 h-[14rem]" src="${Item}" alt="image">
                      <h1 class="text-[1.2rem] font-semibold">$99.50</h1>
                      <h1 class="text-gray-400 leading-5 max-[480px]:text-sm">GoPro HERO6 4K Action <br> Camera - Black</h1>
