...
Layout.innerHTML = `
                    <div ${onClick="displayRow = false"} class="col cursor-pointer py-2 px-[0.65rem] ${displayRow? "bg-white" : "bg-gray-300"}">
                        <i class="fa-lg fa-brands fa-microsoft"></i>
                    </div>
                    <div ${onClick="displayRow = false"} class="row cursor-pointer ${displayRow? "bg-gray-300" : "bg-white"} py-2 px-[0.65rem] border-l border-gray-300">
