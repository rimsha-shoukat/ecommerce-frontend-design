    ...
    if(item.length > 0){
        let cartHtml = item.map((i) =>{
            return `<span class="flex flex-row max-[680px]:flex-col items-start justify-between border-b p-4 max-[1020px]:p-0 border-gray-300 w-[100%]">
                        ...
                        <img class="w-[8rem] h-[8rem] max-[480px]:w-[4rem] max-[480px]:text-sm border border-gray-300 shadow p-2 rounded-md" src="${i}" alt="img">
                        <span class="flex flex-col items-start justify-start">
                            ...
                            <h1 class="text-gray-500 text-nowrap max-[480px]:text-sm">Size: medium, Color: blue,  Material: Plastic <br>Seller: Artel Market</h1>
