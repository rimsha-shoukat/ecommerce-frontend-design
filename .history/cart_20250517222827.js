        ...
        let cartHtml = item.map((i) =>{
            return `<span class="flex flex-row max-[680px]:flex-col items-start justify-between border-b p-4 max-[1020px]:p-0 border-gray-300 w-[100%]">
                        ...
                        <span class="flex flex-col max-[680px]:flex-row-reverse max-[680px]:w-[100%] max-[680px]:justify-between max-[680px]:text-[1.35rem] gap-2 items-start justify-end">
                            ...
                            <div class="flex flex-row items-center justify-between px-2 py-[0.3rem] max-[680px]:px-4 font-semibold gap-4 max-[6] w-auto border border-gray-300 shadow rounded-md">
                                <h1>Qty:</h1>
                                <select>
