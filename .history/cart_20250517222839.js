        ...
        let cartHtml = item.map((i) =>{
            return `<span class="flex flex-row max-[680px]:flex-col items-start justify-between border-b p-4 max-[1020px]:p-0 border-gray-300 w-[100%]">
                        ...
                        <span class="flex flex-col items-start justify-start">
                            ...
                            <h1 class="text-gray-500 text-nowrap">Size: medium, Color: blue,  Material: Plastic <br>Seller: Artel Market</h1>
                            <span class="flex flex-row gap-6 mt-4">
                                <button remove="${i}" class="remove px-2 py-[0.3rem] border border-gray-300 cursor-pointer shadow rounded-md text-red-500 font-semibold hover:bg-red-500 hover:text-white">Remove</button>
                                <button save="${i}" class="save px-2 py-[0.3rem] border border-gray-300 cursor-pointer shadow rounded-md text-blue-500 hover:bg-blue-500 hover:text-white font-semibold text-nowrap">Save for later</button>
                            </span>
                        </span>
                        </span>
                        <span class="flex flex-col max-[680px]:flex-row-reverse max-[680px]:w-[100%] max-[680px]:justify-between max-[680px]:text-[1.35rem] gap-2 items-start justify-end">
                            <h1 class="font-semibold">$78.99</h1>
                            <div class="flex flex-row items-center justify-between px-2 py-[0.3rem] max-[680px]:px-4 font-semibold gap-4 max-[680px]:gap w-auto border border-gray-300 shadow rounded-md">
                                <h1>Qty:</h1>
                                <select>
