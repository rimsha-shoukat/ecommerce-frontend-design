...
let listItems1 = productsList1.map((imgSrc) => {
    return `<div id="saveIcon" class="flex flex-row max-[760px]:p-2 p-4 items-start justify-start bg-white rounded-md border border-gray-300 shadow max-[] gap-[1.5rem]">
