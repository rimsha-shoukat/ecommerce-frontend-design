...
let displayRow = true;
let Layout = document.getElementById("itemsLis");
Layout.innerHTML = `
                    <div class="col cursor-pointer py-2 px-[0.65rem] ${displayRow? "bg-white" : "bg-gray-300"}">
                        <i class="fa-lg fa-brands fa-microsoft"></i>
                    </div>
                    <div class="row cursor-pointer ${displayRow? "bg-gray-300" : "bg-white"} py-2 px-[0.65rem] border-l border-gray-300">
