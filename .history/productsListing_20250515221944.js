...
let listItems2 = productsList2.map((imgSrc) => {
    return `<div id="saveIcon" class="flex flex-col p-4 max-[760px]:p-2 items-center justify-center bg-white rounded-md border border-gray-300 shadow max-[690px]:hi gap-[2rem]">
