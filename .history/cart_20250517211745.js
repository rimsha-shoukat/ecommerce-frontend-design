...
function moved(item){
    if(item.length > 0){
        let cartHtml = item.map((i) =>{
            return `<span class="flex flex-row items-start justify-between gap-4 border-b p-4 border-gray-300 w-[100%]">
                        <img class="w-[8rem] h-[8rem] border border-gray-300 shadow p-2 rounded-md" src="${i}" alt="img">
                        <span class="w-[60%] flex flex-col items-start justify-start">
                        ...
                        <span class="flex flex-col gap-2 items-end justify-start w-[20%]">
